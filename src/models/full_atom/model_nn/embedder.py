...
class Embedder(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        node_time_emb = self.time_emb_func(node_t)  # [B, L, time_emb_size]
        ...
        """ Edge features. """
        # time embedding
        edge_time_emb = self.time_emb_func(node_t)  # (B, L, time_emb_size)
        edge_time_emb = edge_time_emb.unsqueeze(2).expand(-1, -1, L, -1)  # -> (B, L, L, time_emb_size)
